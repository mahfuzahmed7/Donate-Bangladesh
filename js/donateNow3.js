document.getElementById('btn-donate-now-3').addEventListener('click', function (event) {
    ...
    const donationAmount = Number(getInputFieldValueById('input-donate-now-3'));
    ...
    const currentDonation = Number(getTextFieldValueById('current-donation-3'));
    ...
    div.innerHTML = `<h4 class="text-2xl font-bold mb-2">${donationAmount} Taka is Donated for Aid for Injured in the Quota Movement</h4>
